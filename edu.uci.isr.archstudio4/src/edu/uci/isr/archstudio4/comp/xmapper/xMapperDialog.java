...
public class xMapperDialog extends Dialog {
	...
	public int open(String[] compChanged){
		...
		Group changeTypeGroup = new Group(mainComposite, SWT.NONE);
		changeTypeGroup.setText("Change Description");
		changeTypeGroup.setLayout(new GridLayout(2, false));
		changeTypeGroup.setLayoutData(new GridData(265, SWT.DEFAULT));
		final Label lChangeTypeValue = new Label(changeTypeGroup, SWT.NONE);
